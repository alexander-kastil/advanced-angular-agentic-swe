...
export class WebmcpNavigationComponent {
  ...
  readonly targets = ['webmcp-signal', 'webmcp-in-components', 'webmcp-form-tool', 'webmcp-store'];
  ...
  constructor() {
    declareExperimentalWebMcpTool({
      name: 'list_demos',
      description: 'List every demo of this WebMCP module with its route segment.',
