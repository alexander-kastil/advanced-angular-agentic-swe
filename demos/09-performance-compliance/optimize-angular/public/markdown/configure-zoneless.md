...
- **Default since Angular v21**: New projects are zoneless and ship no zone.js
...
| **Compatibility**    | Legacy code friendly          | Requires signals or explicit markForCheck |

### Zoneless Requirements

Components must use:

1. **OnPush semantics** - the default in v22, so no `changeDetection` line is needed
